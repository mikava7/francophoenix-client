export const vocabularySectionData = {
  fr: [
    {
      title: "Vocabulaire par thèmes",
      question: "Voulez-vous apprendre les bases de la vocabulaire ?",
      description:
        "Explorez les leçons fondamentales de vocabulaire pour construire une base solide.",
    ...
    },
    {
      ...
      description:
        "Entraînez-vous à choisir la forme correcte des verbes en français.",
      link: "/vocabulary/verb-tense-exercise",
    },
    {
      title: "Flashcards",
      question: "Voulez-vous pratiquer avec des flashcards ?",
      description:
    ...
    },
    {
      ...
      description: "Entraînez-vous à construire des phrases en français.",
