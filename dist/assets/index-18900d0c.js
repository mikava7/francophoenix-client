 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gl=S,JC=YC;function XC(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var ZC=typeof Object.is=="function"?Object.is:XC,eA=JC.useSyncExternalStore,tA=gl.useRef,nA=gl.useEffect,rA=gl.useMemo,iA=gl.useDebugValue;Ny.useSyncExternalStoreWithSelector=function(e,t,n,r,i){var o=tA(null);if(o.current===null){var s={hasValue:!1,value:null};o.current=s}else s=o.current;o=rA(function(){function c(g){if(!u){if(u=!0,d=g,g=r(g),i!==void 0&&s.hasValue){var y=s.value;if(i(y,g))return f=y}return f=g}if(y=f,ZC(d,g))return y;var v=r(g);return i!==void 0&&i(y,v)?y:(d=g,f=v)}var u=!1,d,f,h=n===void 0?null:n;return[function(){return c(t())},h===null?void 0:function(){return c(h())}]},[t,n,r,i]);var a=eA(e,o[0],o[1]);return nA(function(){s.hasValue=!0,s.value=a},[a]),iA(a),a};zy.exports=Ny;var oA=zy.exports;function sA(e){e()}let By=sA;const aA=e=>By=e,lA=()=>By,om=Symbol.for(`react-redux-context-${S.version}`),sm=globalThis;function cA(){let e=sm[om];return e||(e=S.createContext(null),sm[om]=e),e}const Un=new Proxy({},new Proxy({},{get(e,t){const n=cA();return(r,...i)=>Reflect[t](n,...i)}}));function Jf(e=Un){return function(){return S.useContext(e)}}const Iy=Jf(),uA=()=>{throw new Error("uSES not initialized!")};let Fy=uA;const dA=e=>{Fy=e},fA=(e,t)=>e===t;function pA(e=Un){const t=e===Un?Iy:Jf(e);return function(r,i={}){const{equalityFn:o=fA,stabilityCheck:s=void 0,noopCheck:a=void 0}=typeof i=="function"?{equalityFn:i}:i,{store:c,subscription:u,getServerState:d,stabilityCheck:f,noopCheck:h}=t();S.useRef(!0);const g=S.useCallback({[r.name](v){return r(v)}}[r.name],[r,f,s]),y=Fy(u.addNestedSub,c.getState,d||c.getState,g,o);return S.useDebugValue(y),y}}const W=pA();var Dy={exports:{}},oe={};/** @license React v16.13.1
...
`;const Vr=ae("quizData/fetchQuizData",async e=>{try{return(await le.get(`/quiz-topic/${e}`)).data}catch(t){throw console.log(t),Error("Failed to fetch words")}}),Qr=ae("quizData/fetchTopicNames",async()=>{try{return(await le.get("/quiz-topic-names")).data}catch(e){throw console.log(e),Error("Failed to fetch words")}}),zs=ae("selectedVerbDetails/fetchVerbDetails",async e=>{try{return(await le.get(`/get-verb-details/${e}`)).data}catch(t){throw console.log(t),Error("Failed to fetch verb details")}}),pL={selectedVerbDetails:[],currentTopic:[],topicNames:[],isLoading:!1,error:null},hL=Pe({name:"quizData",initialState:pL,reducers:{},extraReducers:e=>{e.addCase(Vr.pending,t=>{t.isLoading=!0}).addCase(Vr.fulfilled,(t,n)=>{t.currentTopic=n.payload,t.isLoading=!1}).addCase(Vr.rejected,(t,n)=>{t.error=n.error.message}).addCase(Qr.pending,t=>{t.isLoading=!0}).addCase(Qr.fulfilled,(t,n)=>{t.topicNames=n.payload,t.isLoading=!1}).addCase(Qr.rejected,(t,n)=>{t.error=n.error.message}).addCase(zs.pending,t=>{t.isLoading=!0}).addCase(zs.fulfilled,(t,n)=>{t.selectedVerbDetails=n.payload,t.isLoading=!1}).addCase(zs.rejected,(t,n)=>{t.error=n.error.message})}}),mL=hL.reducer,Sp="data:image/png;base64,",gL="data:image/png;base64,",Xv=({isActive:e,onClick:t})=>{const r=xi()===hl?gL:Sp;return l.jsx(xL,{src:r,alt:"chevron",rotation:e?180:0,onClick:t})},xL=p.img`
  ...
  cursor: pointer;
`,Zv=({topic:e,selectedCategory:t,onCategoryChange:n})=>(console.log("selectedCategory in CategoryDropdown",t),l.jsx(yL,{children:l.jsx(vL,{children:l.jsx(wL,{value:t,onChange:n,children:e.map((r,i)=>l.jsx("option",{value:r,children:r},i))})})})),yL=p.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`;const kp=({definition:e,secondLanguage:t,index:n,secondLangButtonName:r,isMultipleDefinitions:i})=>{const[o,s]=S.useState(!0),a=()=>{s(!o)};return l.jsxs(OL,{children:[l.jsxs(PL,{children:[l.jsx(o1,{showDefinition:o,onClick:a,children:r}),l.jsx(RL,{showDefinition:o,onClick:a,children:"Fr"})]}),l.jsx($L,{children:i?o?t[n]:e[n]:o?t:e})]})},OL=p.div`
  width: 100%;
`,PL=p.div`
  position: absolute;
  top: 2%;
...
`,Ns=ae("presentTense/fetchPresentTense",async()=>{try{return(await le.get("/verbs/tenses/present")).data}catch(e){throw console.log(e),Error("Failed to fetch words")}}),PO={presentTense:[],isLoading:!1,error:null},$O=Pe({name:"presentTense",initialState:PO,reducers:{},extraReducers:e=>{e.addCase(Ns.pending,t=>{t.isLoading=!0}).addCase(Ns.fulfilled,(t,n)=>{t.presentTense=n.payload,t.isLoading=!1}).addCase(Ns.rejected,(t,n)=>{t.error=n.error.message})}}),RO=$O.reducer,zO=()=>{Ue();const e=ne(),t=W(E=>E.presentTense.presentTense.presentTenseVerbs)||[],n=W(E=>E.presentTense.isLoading),r=W(E=>E.presentTense.error),[i,o]=S.useState(0),[s,a]=S.useState([]),[c,u]=S.useState(Array(t.length).fill("")),[d,f]=S.useState(!1),[h,g]=S.useState(!1),[y,v]=S.useState(0),[b,x]=S.useState(!0),[m,w]=S.useState(!0),[k,A]=S.useState(!1);S.useEffect(()=>{e(Ns())},[e]),S.useEffect(()=>{t.length>0&&a(t.slice(i,i+5))},[i,t]);const C=(E,z)=>{const B=[...c];B[E+i]=z,u(B)},j=()=>{if(s.every((E,z)=>c[z+i]!=="")){const E=s.every((B,M)=>c[M+i]===B.correctAnswer);f(E),g(!0);const z=s.reduce((B,M,I)=>c[I+i]===M.correctAnswer?B+1:B,0);v(B=>B+z),w(!1),A(!E)}},T=()=>{i+5>=t.length?x(!1):(o(E=>E+5),g(!1),w(!0),A(!1),u(Array(t.length).fill("")))},O=()=>{g(!1),w(!0),A(!1),u(Array(t.length).fill(""));const E=s.reduce((z,B,M)=>c[M+i]===B.correctAnswer?z+1:z,0);v(z=>z-E)},P=()=>{o(0),u(Array(t.length).fill("")),f(!1),g(!1),v(0),x(!0)};return n?l.jsx(Be,{}):r?l.jsx("div",{children:r}):l.jsxs(NO,{children:[l.jsxs(DO,{children:["Score: ",y,"/",t.length]}),s.map((E,z)=>{const B=E.sentence.indexOf("_"),M=E.sentence.slice(0,B),I=E.sentence.slice(B+5);return l.jsxs(BO,{children:[z+1+i,": ",M,l.jsxs("span",{children:[E.words.map((_,$)=>l.jsx(FO,{onClick:()=>C(z,_),"data-questioncorrectanswer":E.correctAnswer===_,"data-usersanswer":c[z+i],"data-showanswers":h&&c[z+i]===_,"data-allanswerscorrect":d,children:_},$)),I]})]},z)}),l.jsxs(_O,{children:[m&&l.jsx(Bs,{onClick:j,children:"Submit"}),h&&!d&&b&&l.jsx(l.Fragment,{children:k?l.jsx(Bs,{onClick:O,children:"Retry"}):l.jsx(Bs,{onClick:j,children:"Submit"})}),l.jsx(WO,{onClick:T,children:"Next"}),h&&!d&&!b&&l.jsxs(MO,{children:["Your final score is: ",y,l.jsx(UO,{onClick:P,children:"Restart"})]})]})]})},NO=p.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,IO=e=>{const t=e["data-usersanswer"]===e.children,n=e["data-showanswers"],r=e["data-questioncorrectanswer"];return t&&n?r?"green":"red":t?"violet":n&&e["data-allanswerscorrect"]==="true"?"green":e.theme.secondaryBackground},FO=p.button`
  border-radius: 8px;
  font-size: 1.2rem;
...
`,x3=()=>{const[e,t]=S.useState(!0),[n,r]=S.useState(!1),[i,o]=S.useState(!0),s=gr(),{t:a,i18n:c}=q();S.useEffect(()=>{localStorage.getItem("nativeLanguageSelected")?(t(!1),r(!0)):s.pathname==="/"&&t(!0),o(!1)},[s]);const u=h=>{t(!1),localStorage.setItem("nativeLanguageSelected",h),r(!0),c.changeLanguage(h)},d=ne();Ue();const f=W(h=>h.books.books);return W(h=>h.books.isLoading),W(h=>h.vocabularyTopics.vocabularyTopics),W(h=>h.vocabularyTopics.isLoading),S.useEffect(()=>{d(Yi())},[]),S.useEffect(()=>{d(Ji())},[]),i?l.jsx(Be,{}):l.jsxs(y3,{children:[e&&l.jsx(C3,{showoverlay:e,children:l.jsx(v3,{children:l.jsx(g3,{handleLanguagePopupClose:u})})}),l.jsx(x1,{}),l.jsx(s3,{}),l.jsxs(w3,{children:[l.jsxs(b3,{children:[l.jsxs(S3,{children:[a("Tous les livres")," "]}),l.jsx(k3,{to:"/books/level/a2-b1",children:a("Tout afficher")})]}),l.jsx(tL,{books:f})]}),l.jsx(n3,{})]})},y3=p.section`
  margin: 0 1rem;
...
`;const P3=e=>e.showAnswers&&e.answers===e.option?e.questionCorrectAnswer&&e.showAnswers?"green":"red":e.usersAnswer&&e.answers===e.option?"violet":e.showAnswers&&e.allAnswersCorrect?"green":"white",$3=p.button`
  border-radius: 8px;
  font-size: 1.4rem;
  padding: 0.5rem;
  cursor: pointer;
...
`;p(Oe)`
  ...
  margin-bottom: 10px;
  text-decoration: none;
`;const O5=({title:e,duration:t,difficulty:n,vocabularyCount:r,description:i,image:o,phrase:s})=>l.jsxs(P5,{children:[l.jsxs($5,{children:[l.jsx(R5,{src:o,alt:e}),l.jsx("p",{children:s})]}),l.jsx("h3",{children:e}),l.jsxs(z5,{children:["Duration:",l.jsx("span",{children:t})]}),l.jsxs(N5,{children:["Difficulty:",l.jsx("span",{children:n})]}),l.jsxs(B5,{children:["Vocabulary Count:",l.jsx("span",{children:r})]}),l.jsxs(I5,{children:["Description:",i]})]}),P5=p.div`
  background-color: #f0f0f0;
  border-radius: 8px;
  min-width: 260px;
  max-width: 520px;
...
`,j1=()=>{const{t:e,i18n:t}=q(),[n,r]=S.useState(!1),[i,o]=S.useState(!1),s=localStorage.getItem("nativeLanguageSelected"),a=localStorage.getItem("targetLanguageSelected"),c=(g,y)=>{t.changeLanguage(g),localStorage.setItem(`${y}LanguageSelected`,g),r(!1),o(!1)},u=tr.filter(g=>g.code!==s&&g.code!==a),d=tr.filter(g=>g.code!==s&&g.code!==a),f=tr.find(g=>g.code===s),h=tr.find(g=>g.code===a);return l.jsxs(K5,{children:[l.jsxs(mg,{children:[l.jsxs(gg,{onClick:()=>r(!n),children:[l.jsx(Y5,{children:e("Je parle")}),l.jsxs(yg,{children:[l.jsx("img",{src:f==null?void 0:f.icon,alt:f==null?void 0:f.code}),f==null?void 0:f.name]})]}),n&&l.jsx(xg,{children:u.map(g=>l.jsxs("button",{onClick:()=>c(g.code,"native"),children:[l.jsx("img",{src:g.icon,alt:g.code}),g.name]},g.code))})]}),l.jsxs(mg,{children:[l.jsxs(gg,{onClick:()=>o(!i),children:[l.jsxs(yg,{children:[l.jsx("img",{src:h==null?void 0:h.icon,alt:h==null?void 0:h.code}),h==null?void 0:h.name]}),l.jsx(J5,{children:e("J'apprends")})]}),i&&l.jsx(xg,{children:d.map(g=>l.jsxs("button",{onClick:()=>c(g.code,"target"),children:[l.jsx("img",{src:g.icon,alt:g.code}),g.name]},g.code))})]})]})},K5=p.div`
  display: flex;
  justify-content: space-around;
  align-items: center;
  width: 480px;
...
`,Ua=p(Lo)``,RP=({isDarkMode:e,t,toggleTheme:n,handleMenuClick:r})=>{var b,x;const i=ne(),[o,s]=S.useState(!1),a=W(m=>m.auth.isAuthenticated),c=W(m=>m.auth.auth)||{},u=(b=c.user)==null?void 0:b._id,d=(x=c.user)==null?void 0:x.username;S.useState(!1);const[f,h]=S.useState({}),g=({e:m,categoryIndex:w})=>{m.stopPropagation(),h(k=>({...k,[w]:!k[w]}))},y=()=>{s(!1)};S.useEffect(()=>(document.body.addEventListener("click",y),()=>{document.body.removeEventListener("click",y)}),[]);const v=m=>{m.stopPropagation(),i(qr(u))};return l.jsx(zP,{class:"content",children:l.jsxs(NP,{id:"menuToggle",onClick:m=>r(m),children:[l.jsx("input",{type:"checkbox",checked:o,onChange:()=>s(!o)}),l.jsx("span",{style:{background:e?"#ffffff":"#000000"}}),l.jsx("span",{style:{background:e?"#ffffff":"#000000"}}),l.jsx("span",{style:{background:e?"#ffffff":"#000000"}}),l.jsxs(BP,{children:[l.jsxs(FP,{children:[l.jsxs(DP,{children:[l.jsx(F1,{to:"/",children:"Francophoenix"}),l.jsx(HP,{children:l.jsx(A1,{toggleTheme:n,isDarkMode:e})})]}),l.jsx(j1,{}),l.jsx(MP,{children:l.jsx(_P,{children:a?l.jsx(UP,{children:l.jsxs(WP,{children:[l.jsx("img",{src:Hd,alt:"User Icon"}),d]})}):t("Pas connecté")})}),!a&&l.jsxs(l.Fragment,{children:[l.jsxs(bg,{children:[l.jsx("p",{children:t("Avez-vous déjà un compte?")}),l.jsx(Sg,{to:"/login",children:t("Connexion")})]}),l.jsxs(bg,{children:[" ",l.jsx("p",{children:t("Pas de compte?")}),l.jsxs(Sg,{to:"/register",children:[t("Inscrivez-vous")," "]})]})]})]}),l.jsx(l.Fragment,{children:kP.map((m,w)=>l.jsxs(VP,{children:[l.jsxs("div",{children:[l.jsx(Ua,{to:m.link,children:t(m.title)}),m.subItems&&m.subItems.length>0&&l.jsx(GP,{onClick:k=>g({e:k,categoryIndex:w}),children:f[w]?"▲":"▼"})]}),f[w]&&m.subItems&&m.subItems.length>0&&l.jsx("ul",{children:m.subItems.map((k,A)=>l.jsx(I1,{children:l.jsx(Ua,{to:k.link,children:t(k.title)})},A))})]},w))}),a&&l.jsx(QP,{children:l.jsx(jp,{handleLogout:v})}),l.jsx(IP,{})]})]})})},zP=p.div`
  display: flex;
  align-items: center;
`,NP=p.div`
  display: flex;
...
`,GP=p.span`
  /* padding: 1rem; */
`,qP=({toggleTheme:e,isDarkMode:t})=>{const{t:n,i18n:r}=q(),i=r.language==="ka",o=U5();S.useState(!1);const s=a=>{a.stopPropagation()};return l.jsxs(KP,{isVisible:o,children:[l.jsx(RP,{isDarkMode:t,toggleTheme:e,t:n,handleMenuClick:s}),l.jsx(JP,{children:l.jsx(F1,{to:"/",children:"Home"})}),l.jsxs(YP,{children:[l.jsx(us,{to:"/grammar/basic-grammar-lessons",isGeorgian:i,children:n("Grammaire")}),l.jsx(us,{to:"/vocabulary/vocabulary-topics",isGeorgian:i,children:n("Vocabulaire")}),l.jsx(us,{to:"/reading-zone/french-easy-reading",isGeorgian:i,children:n("Livres")}),l.jsx(us,{to:"/dictionary",isGeorgian:i,children:n("Dictionnaire")})]}),l.jsxs(XP,{children:[l.jsx(A1,{toggleTheme:e,isDarkMode:t}),l.jsx(oP,{})]})]})},KP=p.div`
  box-sizing: border-box;
  position: sticky;
  top: 0;
  left: 0;
...
Résumé:
Le festival de Cannes rassemble, comme chaque année, les stars du cinéma et toute la presse. Naturellement, Alex Leroc y va. C’est le printemps, il fait beau sur la Côte d’Azur. Les conditions sont idéales pour la grande fête du cinéma. Alex s’intéresse à un acteur parisien et sa petite amie top modèle, un couple apparemment parfait`,kg=()=>{Ue();const e=ne(),t=W(a=>a.books.books)||[],n=W(a=>a.books.isLoading),[r,i]=S.useState(null);S.useEffect(()=>{e(Yi())},[e]);const o=a=>{const c=a.target.value==="Tous"?null:a.target.value;i(c)},s=r?t.filter(a=>a.level===r):t;return n?l.jsx(Be,{}):l.jsxs(p$,{children:[l.jsx(h$,{children:"Our Best Books"}),l.jsx(a$,{onChange:o,selectedLevel:r}),l.jsx(m$,{children:s.map(a=>l.jsx(g$,{children:l.jsx(x$,{to:`/reading-zone/french-easy-reading/${a._id}`,children:l.jsx(M1,{books:a,description:f$})})},a._id))})]})},p$=p.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  max-width: 100%;
...
`,ou=p.li`
  font-size: 18px;
  margin-bottom: 5px;
`,b$=()=>l.jsxs(y$,{children:[l.jsx(v$,{children:"A1-A2 Level Books"}),l.jsxs(w$,{children:[l.jsx(ou,{children:"Book 1 for A1-A2 Level"}),l.jsx(ou,{children:"Book 2 for A1-A2 Level"}),l.jsx(ou,{children:"Book 3 for A1-A2 Level"})]})]}),S$=p.div`
  padding: 20px;
`,k$=p.h2`
  font-size: 24px;
  font-weight: bold;
...
`,su=p.li`
  font-size: 18px;
  margin-bottom: 5px;
`,A$=()=>l.jsxs(S$,{children:[l.jsx(k$,{children:"A1-A2 Level Books"}),l.jsxs(C$,{children:[l.jsx(su,{children:"Book 1 for A1-A2 Level"}),l.jsx(su,{children:"Book 2 for A1-A2 Level"}),l.jsx(su,{children:"Book 3 for A1-A2 Level"})]})]});p.div`
  display: inline;
  position: relative;
`;p.div`
  display: flex;
...
`;p.div`
  ...
  min-width: 200px;
  max-width: 350px;
`;const Cg=({selectedChapter:e,totalChapters:t,onPrevious:n,onNext:r})=>{const{t:i}=q();return l.jsxs(j$,{children:[l.jsx(Ag,{onClick:n,disabled:e===0,children:i("Chapitre précédent")}),l.jsx(Ag,{onClick:r,disabled:e===t-1,children:i("Chapitre suivant")})]})},j$=p.div`
  display: flex;
  /* outline: 1px solid red; */
  justify-content: space-between;
  align-items: center;
...
.styles-module_tooltip__mnnfp{padding:8px 16px;border-radius:3px;font-size:90%;width:max-content}.styles-module_arrow__K0L3T{width:8px;height:8px}[class*='react-tooltip__place-top']>.styles-module_arrow__K0L3T{transform:rotate(45deg)}[class*='react-tooltip__place-right']>.styles-module_arrow__K0L3T{transform:rotate(135deg)}[class*='react-tooltip__place-bottom']>.styles-module_arrow__K0L3T{transform:rotate(225deg)}[class*='react-tooltip__place-left']>.styles-module_arrow__K0L3T{transform:rotate(315deg)}.styles-module_dark__xNqje{background:var(--rt-color-dark);color:var(--rt-color-white)}.styles-module_light__Z6W-X{background-color:var(--rt-color-white);color:var(--rt-color-dark)}.styles-module_success__A2AKt{background-color:var(--rt-color-success);color:var(--rt-color-white)}.styles-module_warning__SCK0X{background-color:var(--rt-color-warning);color:var(--rt-color-white)}.styles-module_error__JvumD{background-color:var(--rt-color-error);color:var(--rt-color-white)}.styles-module_info__BWdHW{background-color:var(--rt-color-info);color:var(--rt-color-white)}`,type:"base"})});const _1=()=>{xi();const{verb:e}=_n(),{handleListen:t,isActiveStates:n}=_e(),r=gr(),o=new URLSearchParams(r.search).get("conjugated"),s=ne(),a=W(v=>v.quizData.selectedVerbDetails)||[],c=W(v=>v.quizData.isLoading);W(v=>v.quizData.error),S.useEffect(()=>{s(zs(e))},[s]);const{verb:u,verbEng:d,verbGeo:f,forms:h}=a,{i18n:g}=q(),y=g.language==="ka";return c?l.jsx(Be,{}):l.jsxs(O$,{children:[l.jsxs(P$,{children:[l.jsx("h1",{children:(u==null?void 0:u.charAt(0).toUpperCase())+(u==null?void 0:u.slice(1))}),l.jsx("h3",{children:y?f:d})]}),l.jsx($$,{children:h&&(Object==null?void 0:Object.entries(h).map(([v,b])=>l.jsxs(R$,{children:[l.jsx("h2",{children:v.replace(/([A-Z])/g," $1").replace(/^./,x=>x.toUpperCase())}),l.jsx(z$,{children:l.jsx("ul",{children:b==null?void 0:b.map((x,m)=>l.jsxs("li",{children:[l.jsxs(I$,{highlight:x==null?void 0:x.french.includes(o),children:[l.jsx(N$,{children:x==null?void 0:x.french})," ",l.jsx(Kl,{onClick:t(x==null?void 0:x.french),isActive:n[m],children:l.jsx(nt,{})})]}),l.jsx(B$,{children:y?x==null?void 0:x.georgian:x==null?void 0:x.english})]},m))})})]},v)))})]})},O$=p.div`
  display: flex;
  flex-direction: column;
...
`,I$=p.div`
  ...
  padding-top: 0.4rem;
`,U1=({tooltipContent:e,index:t,conjugated:n,id:r})=>{const{t:i,i18n:o}=q(),{definition:s,english:a,georgian:c,french:u}=e;console.log({definition:s,english:a,georgian:c,french:u});const{handleListen:d,isActiveStates:f}=_e(),[h,g]=S.useState(!1);return l.jsxs(F$,{children:[l.jsxs(D$,{children:[l.jsx(_$,{onClick:d(u),children:l.jsx(nt,{isActive:f[t]})}),l.jsx(H$,{to:`/verbs/${u}?conjugated=${n}`,children:l.jsx(W1,{children:u})})]}),l.jsx(M$,{children:o.language==="ka"?c:a}),l.jsxs(U$,{children:[l.jsx("span",{children:"Add to"}),l.jsx(Mo,{word:u,secondLanguage:o.language==="ka"?c:a,definition:s})]}),h&&l.jsx(W$,{children:l.jsx(_1,{})})]})},F$=p.span`
  max-width: 100%;
...
`,H$=p(Oe)`
  ...
  margin-left: 1rem;
  color: ${e=>e.theme.primaryBackground};
`,H1=({uniqueVerbs:e})=>{const{t}=q(),n=r=>{const o=`https://conjugaison.bescherelle.com/verbes/${r.replace(/\s+/g,"-")}`;window.open(o,"_blank")};return l.jsxs(V$,{children:[l.jsx("h3",{children:t("Verbes utilisés dans le texte")}),e.map((r,i)=>l.jsx("li",{children:l.jsx("button",{onClick:()=>n(r),children:r})},i))]})},V$=p.ul`
  display: flex;
  list-style: none;
  flex-wrap: wrap;
  height: 170px;
...
`,fR=p.span`
  ...
  flex-direction: column;
  /* align-items: center; */
`,pR=(e,t)=>{const n=[],r=new Set,i=o=>Math.floor(Math.random()*t.length);for(;n.length<e.length;){const o=i();if(r.has(o))continue;const s=e[o],c=t[o],u=[];for(;u.length<3;){const h=i(),g=t[h];!u.includes(g)&&g!==c&&u.push(g)}const d=[c,...u].sort(()=>Math.random()-.5),f={question:s,options:d,answer:c};n.push(f),r.add(o)}return n},V1=({onClose:e,isQuizFinished:t,isAllCorrect:n,Restart:r,incorrectlyAnsweredQuestions:i})=>{const{t:o}=q(),s=()=>{e(),window.scrollTo({top:0,behavior:"smooth"})};return l.jsx(hR,{children:t&&l.jsxs(mR,{children:[n?l.jsx(Tg,{children:o("Félicitations! Vous avez répondu correctement à tous.")}):l.jsxs(Tg,{children:[o("Toutes les réponses ne sont pas correctes. Réessayer!"),l.jsx(yR,{children:i.map(a=>l.jsx("li",{children:a.question}))})]}),l.jsxs(xR,{children:[l.jsx(e1,{onClick:s,children:o("Réviser le vocabulaire")}),l.jsx(gR,{onClick:e,isAllCorrect:n,children:n?o("Fermer"):r})]})]})})},hR=p.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,K1=({index:e,expandedIndex:t,definition:n})=>l.jsx(zR,{isExpanded:e===t,children:l.jsx(NR,{children:n[e]})}),zR=p.div`
  width: 95%;
  margin: 0 auto;
  margin-left: -0.1rem;
...
`,JR=p.div`
  ...
  margin: 0 1rem;
`,J1=({selectedFlashcards:e})=>{const{handleListen:t,isActiveStates:n}=_e(),{t:r,i18n:i}=q(),o=i.language==="ka",[s,a]=S.useState(0),[c,u]=S.useState(0),[d,f]=S.useState(4),[h,g]=S.useState(100),[y,v]=S.useState(!1),[b,x]=S.useState(!1),[m,w]=S.useState(!0),k=e==null?void 0:e.map(P=>P.word),A=e==null?void 0:e.map(P=>P.secondLanguage);S.useEffect(()=>{const P=setInterval(()=>{!y&&!b&&(d>0?(f(E=>E-1),g(E=>E-25)):(a(E=>E===k.length-1?0:E+1),u(E=>E+1),f(4),g(100)))},1e3);return()=>{clearInterval(P)}},[d,k,y,s,b]),S.useEffect(()=>{s>0&&s%4===0&&v(!0)},[s]);const C=()=>{v(!1)},j=()=>{x(!b)},T=P=>{w(P.target.value==="word")},O=localStorage.getItem("targetLanguageSelected");return l.jsx(ZR,{children:y?l.jsxs(s4,{children:[l.jsxs("div",{children:[" ",r("Mots déjà revus"),l.jsx("p",{children:c})]}),l.jsx(TL,{children:r("Vous suivez ?")}),l.jsx(e1,{onClick:C,children:r("Continue")})]}):l.jsxs(l.Fragment,{children:[l.jsxs(e4,{children:[l.jsxs(XR,{onChange:T,children:[l.jsx("option",{value:"word",children:r("Français")}),l.jsx("option",{value:"translation",children:r(o?"ქართული":"English")})]}),l.jsxs(t4,{children:[l.jsx(o4,{children:d}),l.jsxs(n4,{children:[l.jsx(Kl,{onClick:t(k[s],O),isActive:n[s],children:l.jsx(nt,{})}),m?k[s]:A[s]]})]}),l.jsx(r4,{style:{filter:`blur(${h}px)`},children:l.jsx(i4,{children:m?A[s]:k[s]})})]}),l.jsx(qe,{onClick:j,children:b?"Resume":"Pause"})]})})},XR=p.select`
  margin-top: 1rem;
  font-size: 1rem;
  padding: 0.25rem;
`,ZR=p(EL)`
...
`,l4=p.div`
  ...
  width: 97%;
  padding: 1rem;
`,c4=()=>{var A,C,j,T,O,P;const{topicId:e}=_n(),t=ne(),n=W(E=>E.quizData.currentTopic),r=W(E=>E.quizData.isLoading),i=n==null?void 0:n.words,o=(A=n==null?void 0:n.words)==null?void 0:A.map(E=>E==null?void 0:E.french);(C=n==null?void 0:n.words)==null||C.map(E=>E==null?void 0:E.english),(j=n==null?void 0:n.words)==null||j.map(E=>E==null?void 0:E.georgian);const s=(T=n==null?void 0:n.words)==null?void 0:T.map(E=>E==null?void 0:E.definition),{t:a,i18n:c}=q(),u=c.language==="ka",d=i==null?void 0:i.map(E=>({word:E==null?void 0:E.french,definition:E==null?void 0:E.definition,secondLanguage:u?E.georgian:E.english})),f=localStorage.getItem("targetLanguageSelected"),h=localStorage.getItem("nativeLanguageSelected"),g={fr:"french",en:"english",ka:"georgian"},y=g[f],v=(O=n==null?void 0:n.words)==null?void 0:O.map(E=>E==null?void 0:E[y]),b=g[h],x=(P=n==null?void 0:n.words)==null?void 0:P.map(E=>E==null?void 0:E[b]);S.useEffect(()=>{e&&t(Vr(e))},[]);const[m,w]=S.useState(null),{vocabularyTopicId:k}=_n();return S.useEffect(()=>{t(Ji())},[t,k]),r?l.jsx(Be,{}):l.jsxs(u4,{children:[l.jsx(j1,{}),l.jsxs(f4,{children:[a("Les mots")," ",l.jsx("b",{children:o&&(o==null?void 0:o.length)})]}),l.jsx(d4,{children:l.jsx(BR,{wordsInTargetLanguage:v,secondLanguage:x,definition:s})}),l.jsxs(h4,{children:[l.jsx(ds,{type:a("Mémoriser des mots"),identifier:"Mémoriser des mots",isOpen:m==="Mémoriser des mots",onToggle:()=>w(m==="Mémoriser des mots"?null:"Mémoriser des mots"),selectedFlashcards:d}),l.jsx(ds,{type:a("Texte"),identifier:"Texte",isOpen:m==="Texte",onToggle:()=>w(m==="Texte"?null:"Texte"),vocabularyData:n,french:o}),n&&n.type&&l.jsx(l.Fragment,{children:n.type.some(E=>E.typeEn==="noun")&&l.jsx(ds,{type:a("Genre des noms"),identifier:"Genre des noms",isOpen:m==="Genre des noms",onToggle:()=>w(m==="Genre des noms"?null:"Genre des noms"),french:o})}),l.jsx(ds,{type:a("Questionnaire"),identifier:"Questionnaire",isOpen:m==="Questionnaire",onToggle:()=>w(m==="Questionnaire"?null:"Questionnaire"),secondLanguage:x,wordsInTargetLanguage:v,french:o})]})]})},u4=p.article`
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
  overflow: hidden;
...
`;const m4=()=>{const[e,t]=S.useState(null),{t:n}=q(),r=W(d=>d.isFavorite.favorites),i=ne(),{handleListen:o,isActiveStates:s}=_e(),a=d=>{i(a1(r[d]))},c=()=>{i(JL())},u=d=>{t(f=>f===d?null:d)};return l.jsxs(g4,{children:[l.jsx("h2",{children:n("Mots favoris")}),r.length===0?l.jsx("p",{children:n("Pas de mots favoris")}):l.jsxs(x4,{children:[r.filter(d=>Object.keys(d).length>0).map((d,f)=>l.jsxs(y4,{children:[l.jsxs(v4,{children:[l.jsx("span",{children:d.word}),l.jsx("span",{children:d.secondLanguage}),l.jsxs(w4,{children:[l.jsx(k4,{onClick:o(d.word),isActive:s[f],children:l.jsx(nt,{})}),l.jsx(b4,{src:l1,alt:"Favorite",onClick:()=>a(f)}),l.jsx(S4,{onClick:()=>u(f),isExpanded:f===e,children:"▾"})]})]}),l.jsx(K1,{index:f,expandedIndex:e,frenchExamples:d.frenchExamples,secondLanguageExamples:d.secondLanguageExamples})]},f)),l.jsx(qe,{onClick:c,children:"Clear All"})]})]})},g4=p.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,C4=()=>{Ue();const e=ne(),{t,i18n:n}=q(),r=W(b=>b.quizData.topicNames)||[],i=W(b=>b.quizData.isLoading);S.useState(null);const[o,s]=S.useState(""),[a,c]=S.useState(!1),u=[...new Set(r.map(b=>JSON.stringify(b.category)))].map(b=>JSON.parse(b));S.useEffect(()=>{e(Qr())},[e]);const d=localStorage.getItem("targetLanguageSelected"),f=localStorage.getItem("nativeLanguageSelected"),h=o?r.filter(b=>{const x=`category${f.charAt(0).toUpperCase()+f.slice(1)}`;return b.category[x]===o}):r,g=(b,x)=>{if(tr.find(w=>w.code===x))switch(x){case"fr":return b.topic;case"en":return b.topicEng;case"ka":return b.topicGeo;default:return b.topic}return b.topic},y=()=>{c(!a)},v=b=>{const x=`category${f.charAt(0).toUpperCase()+f.slice(1)}`;s(b[x]||b.categoryEn),c(!1)};return i?l.jsx(Be,{}):l.jsxs("div",{children:[l.jsxs(R4,{children:[l.jsxs(z4,{onClick:y,children:[o||"All",l.jsx(N4,{})]}),l.jsx(B4,{showOptions:a,children:u.map(b=>l.jsx(I4,{value:b.categoryEn,onClick:()=>v(b),children:b[`category${f.charAt(0).toUpperCase()+f.slice(1)}`]},b.categoryFr))})]}),l.jsx(A4,{children:h.map(b=>l.jsx(j4,{to:`/vocabulary-topics/${b._id}`,children:l.jsxs(E4,{children:[l.jsx(T4,{src:b.imageUrl,alt:"Vocabulary Topic"}),l.jsxs(O4,{children:[l.jsxs(X1,{children:[g(b,d)," "]}),l.jsxs(L4,{children:[g(b,f)," "]})]})," ",l.jsxs(P4,{children:[l.jsx("span",{children:t("Nombre de mots")}),l.jsx("strong",{children:b.wordsCount})]}),l.jsx($4,{children:b&&b.type&&b.type[`type${(f==null?void 0:f.charAt(0).toUpperCase())+(f==null?void 0:f.slice(1))}`]||"Default Value"})]})},b._id))})]})},A4=p.ul`
  display: flex;
  align-items: center;
...
`,q4=()=>{const e=ne(),t=W(r=>r.dialogueTopics.dialogueTopics)||[],n=W(r=>r.dialogueTopics.isLoading);return S.useEffect(()=>{e(eo())},[]),n?l.jsx(Be,{}):l.jsx("div",{children:t&&t.map(r=>l.jsx(K4,{to:`/dialogue-topics/${r._id}`,children:l.jsx(_4,{dialogueTopics:[r]})},r._id))})},K4=p(Oe)`
  text-decoration: none;
  /* background-color: red; */
`,Y4=({words:e})=>{const t=e.map(h=>h.french),n=e.map(h=>h.english),r=e.map(h=>h.georgian),i=e.map(h=>h.definition),{handleListen:o,isActiveStates:s}=_e(),{t:a,i18n:c}=q(),u=c.language==="ka",d=u?r:n,f=u?"Geo":"Eng";return l.jsxs(J4,{children:[l.jsx(X4,{children:"Vocabulary"}),l.jsx("div",{children:t.map((h,g)=>l.jsxs(Z4,{children:[l.jsx(ez,{onClick:o(h),children:h}),l.jsx(kp,{definition:i,secondLanguage:d,secondLangButtonName:f,french:t,index:g,isMultipleDefinitions:!0}),l.jsx(tz,{children:l.jsxs(nz,{children:[l.jsx(rz,{onClick:o(h),children:l.jsx(nt,{})}),l.jsx(ZL,{word:h,definition:i[g],secondLanguage:d[g],secondLanguageExamples:"No examples"}),l.jsx(Mo,{word:h,frenchExamples:i[g],secondLanguage:d[g],secondLanguageExamples:"No examples"})]})})]},g))})]})},J4=p.div`
  margin-top: 5rem;
  h2 {
    margin-bottom: 3rem;
  }
...
`,rz=p.div`
  display: flex;
`,iz=({phrases:e})=>{const{t,i18n:n}=q(),r=n.language==="ka",i=e.map(g=>g.french),o=e.map(g=>g.english),s=e.map(g=>g.georgian),a=r?s:o,[c,u]=S.useState({}),[d,f]=S.useState(Array(s.length).fill(!1)),h=g=>{u(y=>({...y,[g]:y[g]===0?180:0})),f(y=>{const v=[...y];return v[g]=!v[g],v})};return l.jsxs(oz,{children:[l.jsx("h1",{children:"DialoguePhrase"}),l.jsx("div",{children:i.map((g,y)=>l.jsxs(sz,{children:[l.jsx(az,{children:g}),d[y]&&l.jsx(uz,{children:a[y]}),l.jsx(lz,{onClick:()=>h(y),children:l.jsx(cz,{src:Sp,alt:"ChevronDown",rotation:c[y]||0})})]},y))})]})},oz=p.div`
  width: 100%;
`,sz=p.div`
  background: #ffffec;
  padding: 1rem;
...
`,uz=p.div`
  ...
  font-size: 1.2rem;
  font-style: italic;
`,dz=({isActive:e,onClick:t})=>{const{t:n}=q();return l.jsxs(fz,{children:[l.jsx(hz,{children:n(e?"Cacher Toutes les Traductions":"Afficher toutes les traductions")}),l.jsx(pz,{isActive:e,onClick:t})]})},fz=p.div`
  display: flex;
  flex-direction: column;
`,pz=p.button`
  display: flex;
...
`,mz=()=>{const e=ne(),{dialogueTopicId:t}=_n(),{i18n:n}=q(),r=n.language==="ka",[i,o]=S.useState(!1),[s,a]=S.useState(-1),[c,u]=S.useState({}),{handleListen:d,isActiveStates:f}=_e(),h=C=>{u(j=>({...j,[C]:j[C]===0?180:0})),a(j=>j===C?-1:C)},g=W(C=>C.dialogueTopics.dialogueTopics)||[],y=W(C=>C.dialogueTopics.isLoading),v=g.find(C=>C._id===t);if(S.useEffect(()=>{e(eo())},[]),y)return l.jsx(Be,{});if(!v)return l.jsx("div",{children:"No data available for the selected topic."});const{_id:b,chapter:x,chapterName:{chapterNameEng:m,chapterNameFr:w,chapterNameGeo:k},dialogues:A}=v||{};return l.jsxs(gz,{children:[l.jsxs(Ez,{children:[l.jsx("h1",{children:w}),l.jsx(dz,{isActive:i,onClick:()=>o(!i)})]}),l.jsx("div",{children:A&&A.map((C,j)=>{const{dialogueName:T,dialogueImg:O,dialogue:P,words:E,phrases:z}=C;return l.jsxs(xz,{children:[l.jsx(yz,{children:T}),P.map((B,M)=>{const{speaker:I,messageFr:_,messageEng:$,messageGeo:L}=B,F=r?L:$,N=i||s===M;return l.jsxs(vz,{children:[l.jsxs(bz,{children:[I,":"]}),l.jsxs(wz,{children:[l.jsx(Sz,{children:_}),l.jsxs(Tz,{children:[l.jsx(jz,{onClick:d(_),children:l.jsx(nt,{})}),l.jsx(Cz,{onClick:()=>{h(M)},children:l.jsx(Az,{src:Sp,alt:"ChevronDown",rotation:c[M]||0})})]}),N&&l.jsx(kz,{children:F})]})]},M)}),l.jsx("div",{children:l.jsx(Y4,{words:E})}),l.jsx(iz,{phrases:z})]},j)})})]},b)},gz=p.section`
  display: flex;
  flex-direction: column;
  /* justify-content: center; */
`,xz=p.div`
...
`,Tz=p.div`
  ...
  top: 0%;
  right: 2%;
`,Lz=({topics:e})=>{const{i18n:t}=q(),n=t.language==="ka";if(!e||!e.title)return null;const r=n?e.title.titleGeo:e.title.titleEng;return l.jsxs(Oz,{children:[l.jsx("h2",{children:e.title.titleFr}),l.jsx("h5",{children:r})]})},Oz=p.div`
  display: flex;
  flex-direction: column;
  margin: 0 0.15rem;
  padding: 0.2rem;
...
`,Dz=()=>{const{BasicGrammerTopicId:e}=_n();Ue();const{handleListen:t,isActiveStates:n}=_e(),{t:r,i18n:i}=q(),o=i.language==="ka";ne();const s=W(k=>k.grammer.grammer.find(A=>A._id===e))||[],a=W(k=>k.grammer.isLoading),c=W(k=>k.grammer.error);if(a)return l.jsx(Be,{});if(c)return l.jsx("p",{children:c.message});if(!s)return;const{title:{titleFr:u,titleEng:d,titleGeo:f},description:{descriptionFr:h,descriptionEng:g,descriptionGeo:y},example:{exampleFr:v,exampleEng:b,exampleGeo:x}}=s,m=o?y:g,w=o?x:b;return l.jsxs(ew,{children:[l.jsx(tw,{children:l.jsx("h2",{children:u})}),l.jsxs(nw,{children:[l.jsx("h2",{children:r("Qu'est-ce que c'est ?")}),h.map((k,A)=>l.jsxs(Tp,{children:[k.split(`
`).map((C,j)=>l.jsx("p",{children:C},j)),l.jsx("span",{children:m[A]})]},A))]}),l.jsxs(rw,{children:[l.jsx("h2",{children:r("Examples")}),v.map((k,A)=>l.jsxs(iw,{children:[l.jsxs("div",{children:[l.jsx("p",{children:k})," ",l.jsx(Fz,{onClick:t(k),isActive:n[A],children:l.jsx(nt,{})})]}),l.jsx("span",{children:w[A]})]},A))]})]})},Mz=()=>l.jsx(_z,{children:l.jsx(Uz,{children:"There are no words yet."})}),_z=p.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100px;
...
`,Uz=p.p`
  font-size: 18px;
  color: #333;
`,Wz=({selectedFlashcards:e})=>{console.log("selectedFlashcards",e);const{handleListen:t,isActiveStates:n}=_e(),[r,i]=S.useState(0),[o,s]=S.useState([]),[a,c]=S.useState([]),[u,d]=S.useState(""),[f,h]=S.useState(null),[g,y]=S.useState([]);S.useEffect(()=>{if(e.length>0&&r<e.length){const A=e[r],C=A.split("");console.log("lettersAndSpaces",C),d(A),console.log("flashcard",A),C.sort(()=>Math.random()-.5),y([...C]),h(A),c([])}},[e,r]);const v=A=>{s(o.filter(C=>C!==A)),c(a.filter((C,j)=>j!==A)),y([...g,a[A]])},b=A=>{s([...o,A]),c([...a,g[A]]),y(g.filter((C,j)=>j!==A))},x=()=>{s([]),c([]),y(u.split(""))},m=a.join("")===u,w=o.length===u.length,k=()=>{s([]),c([]),r+1<e.length&&i(A=>A+1)};return l.jsxs(Hz,{children:[l.jsx(qz,{onClick:t(f),children:"Play the word"}),l.jsxs(Vz,{children:[l.jsx(ow,{children:a.map((A,C)=>l.jsx(Qz,{onClick:()=>v(C),disabled:a.length>=u.length,selected:!0,children:A},C))}),l.jsx(Gz,{children:g.map((A,C)=>l.jsx(sw,{onClick:()=>b(C),selected:o.includes(C),children:A},C))})]}),w&&!m&&l.jsx("div",{children:"Incorrect! Try again."}),m&&l.jsxs("div",{children:["Correct! You assembled the word.",r<e.length-1&&l.jsx(qe,{onClick:k,children:"Next"}),r===e.length-1&&l.jsxs(Kz,{children:[l.jsx("p",{children:"Congratulations! You have completed all the words. "}),l.jsx(Yz,{onClick:x,children:"Restart"})]})]})]})},Hz=p.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,Pg=["apple","dog","jump","book","run","cat","tree","play","car","eat","flower","swim"],Jz=({FrenchWord:e,secondLanguageWord:t})=>{const[n,r]=S.useState(0),[i,o]=S.useState(0),[s,a]=S.useState({}),[c,u]=S.useState(0),[d,f]=S.useState(!1),[h,g]=S.useState(!1);S.useEffect(()=>{y()},[i,n]);const y=()=>{if(h){a({});return}if(e.length===0||i>=e.length){g(!0);return}const b=e[i],x=t[i],m=[x];for(;m.length<2;){const w=Math.floor(Math.random()*Pg.length),k=Pg[w];m.includes(k)||m.push(k)}m.sort(()=>Math.random()-.5),a({question:b,options:m,correctOption:x})},v=b=>{d||f(!0),b===s.correctOption&&u(x=>x+1),setTimeout(()=>{i+1<e.length?o(x=>x+1):(o(0),r(x=>x+1),g(!0))},800)};return l.jsxs(Xz,{children:[l.jsxs(eN,{children:[l.jsx("h2",{children:"Topic Title"}),l.jsx(Zz,{children:s.question&&l.jsx(tN,{children:s.question})}),h?l.jsxs(iN,{children:[c===e.length?l.jsxs("div",{children:[l.jsx("h2",{children:"Congratulations! You mastered all words."}),l.jsx("ul",{children:e.map(b=>l.jsx("li",{children:b}))})]}):l.jsxs("h2",{children:["Quiz completed. You scored ",c," out of ",e.length,"."]}),l.jsx(oN,{onClick:()=>window.location.reload(),children:c===e.length?"Play Again":"Retry"})]}):Array.isArray(s.options)&&s.options.map((b,x)=>l.jsx(nN,{onClick:()=>v(b),isSelected:s.selectedOption===b,isCorrect:b===s.correctOption,children:b},x))]}),l.jsxs(rN,{children:["Score: ",c]})]})},Xz=p.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,uu=p.div`
  ...
  overflow-x: hidden;
  width: 97%;
`,SN=({description:e,highlight:t,link:n})=>l.jsxs(CN,{children:[l.jsxs(lw,{children:[e,l.jsx(Hn,{to:n,children:l.jsx(qe,{children:"Explore"})})]}),l.jsx(kN,{children:l.jsx("img",{src:t,alt:"highlight"})})]}),lw=p.div`
  font-size: 1.4rem;
  width: 330px;
  padding: 0.5rem 1rem;
  outline: 2px solid ${e=>e.theme.primaryText};
...
`,AN=[{description:"Test your vocabulary knowledge with QuizPictures. Identify correct words based on images and improve your language skills.",highlight:"/images/screenShots/games/pictureQuiz.png",link:"/quiz-pictures"},{description:"SentenceBuilderEx is a game that helps you practice building sentences. Select words to construct accurate sentences and enhance your language abilities.",highlight:"/images/screenShots/games/sentenceBuilder.png",link:"/sentence-builder-Ex"},{description:"exercise-article is a game that helps you practice french articles.",highlight:"/images/screenShots/games/LeLa.png",link:"/vocabulary-topics/exercise-article"}],jN=()=>l.jsx(EN,{children:AN.map(e=>{const{description:t,highlight:n,link:r}=e;return l.jsx(SN,{link:r,description:t,highlight:n})})}),EN=p.div`
  ...
  justify-content: space-evenly;
  margin-bottom: 1rem;
`,TN=()=>l.jsx(LN,{children:l.jsx(ON,{children:"Content coming soon..."})}),LN=p.div`
  display: flex;
  justify-content: center;
  align-items: center;
  min-height: 300px;
...
`,FN=()=>{Ue();const{TopicId:e}=_n(),t=Yf(),{handleListen:n,isActiveStates:r}=_e(),{t:i,i18n:o}=q(),s=o.language==="ka",a=(C,j)=>{for(const T in C)if(C.hasOwnProperty(T)&&Array.isArray(C[T])){const O=C[T].find(P=>P._id===j);if(O)return O}return null},c=W(C=>a(C.grammer.topicsByAspect,e)),u=W(C=>C.grammer.isLoading),d=W(C=>C.grammer.error);if(S.useEffect(()=>{c==null&&t("/grammar/basic-grammar-lessons")},[t,c]),u)return l.jsx(Be,{});if(d)return l.jsx(To,{});if(!c&&c===null)return null;const{title:{titleFr:f,titleEng:h,titleGeo:g},description:{descriptionFr:y,descriptionEng:v,descriptionGeo:b},example:{exampleFr:x,exampleEng:m,exampleGeo:w}}=c,k=s?b:v,A=s?w:m;return l.jsxs(ew,{children:[l.jsx(tw,{children:l.jsx("h1",{children:f})}),l.jsxs(nw,{children:[l.jsx("h2",{children:i("Qu'est-ce que c'est ?")}),y.map((C,j)=>l.jsxs(Tp,{children:[l.jsx("p",{children:C}),l.jsx("span",{children:k[j]})]},j))]}),l.jsxs(rw,{children:[l.jsx("h2",{children:i("Examples")}),x.map((C,j)=>l.jsxs(iw,{children:[l.jsx("div",{children:l.jsxs("p",{children:[C,C.length!==0&&l.jsx(DN,{onClick:n(C),isActive:r[j],children:l.jsx(nt,{})})]})}),l.jsx("span",{children:A[j]})]},j))]})]})},DN=p.span`
  display: flex;
  align-items: center;
`,MN=({topics:e})=>{const{i18n:t}=q(),n=t.language==="ka";if(Ue(),!e)return null;const{title:{titleFr:r,titleEn:i,titleGeo:o}}=e,s=n?o:i;return l.jsxs(_N,{children:[l.jsx("h2",{children:r}),l.jsx("h3",{children:s})]})},_N=p.div`
  display: flex;
  flex-direction: column;
  margin: 0 auto;
  border: 2px solid grey;
